...
class CirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final strokeWith = new Paint()
      ..style = PaintingStyle.fill
      ..color = circle.borderColor;

    canvas
      ..drawCircle(circle.offset, circle.radius + 2 * circle.borderStrokeWidth, strokeWith)
      ..drawCircle(circle.offset, circle.useRadiusInMeter ? circle.realRadius : circle.radius, paint);
  }
